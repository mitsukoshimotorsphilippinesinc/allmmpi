...
class Salary_deduction extends Admin_Controller {
	...
	public function for_approval_confirm()
	{
		...
		if (empty($salary_deduction)) {		
			...
			if ($is_approved == 'yes') {
				...
				$html = "You are about to approve the Warehouse Request with Request Code: <strong>" . $salary_deduction_code . "</strong>. Do you want to continue?";
			} else {
				$html = "<p>You are about to deny the Warehouse Request with Request Code: <strong>" . $salary_deduction_code . "</strong>. <br/>
	...
	public function for_approval_proceed()
	{
		...
		if (empty($salary_deduction)) {		
			...
			if ($is_approved == 'no') {
				...
				$html = "You have denied the Warehouse Request Code: <strong>{$salary_deduction_code}</strong>.";
				...
				$html = "You have successfully approved the Warehouse Request Code: <strong>{$salary_deduction_code}</strong>.";
	...
	public function view_details()
	{
		...
		if (empty($salary_deduction)) {		
			...
			$this->return_json("1","View Details Warehouse Request", array("html" => $html, "title" => $title, "request_status" => $salary_deduction->status));
	...
	public function for_listing_confirm()
	{
		...
		if (empty($salary_deduction)) {		
			...
			if ($listing_action == 'cancel') {
				...
				$html = "<p>You are about to cancel the Warehouse Request with Request Code: <strong>" . $salary_deduction_code . "</strong>. <br/>
							<div id='reasonremarks-container'>
								<span><strong>Reason/Remarks:</strong></span></br>
	...
	public function for_listing_proceed()
	{
		...
		if (empty($salary_deduction)) {		
			...
			if ($listing_action == 'cancel') {
				...
				$html = "You have cancelled the Warehouse Request Code: <strong>{$salary_deduction_code}</strong>.";
				...
				$html = "You have successfully filed the request for approval with Warehouse Request Code: <strong>{$salary_deduction_code}</strong>.";
				$title = "File For Approval :: " . $salary_deduction_code;
