...
?>
<h2>View Agent  <a href='/spare_parts/maintenance/agents' class='btn btn-small' >Back</a></h2>
<hr/>
	...
	<div class="control-group ">
		...
		<div class="controls">
			...
			<?php if($agent_details->image_filename):?>
				<img id="agent_image" style="width:260px; height:172px;" alt="" src="<?= $upload_url; ?>/<?= $agent_details->image_filename ?>">
			<?php endif; ?>
			</label>
		</div>
	</div>
