				...
				<div class="row-fluid">
					<div class="span11">
						<div class="control-group <?= $this->form_validation->error_class('remarks') ?>">
							...
							<div class="controls">
								<?php if(!$isAdd): ?>
								<textarea class='span8' rows="4" placeholder="" name="current_remarks" readonly><?= $service_unit_details->remarks ?></textarea>
								<br/><br/>
...
<script type="text/javascript">
	...
	var searchPersonnel = function(search_key, cb, with_overlay) {
		...
		b.request({
			...
			url: '/spare_parts/service_unit/get_requester',
	...
	var search_item = function() {
		...
		$("#btn_item_search").click(function(e) {
			...
			b.request({
				url: "/spare_parts/service_unit/search_item",
				data: {
